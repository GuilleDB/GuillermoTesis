...
\begin{figure}[h]
	\begin{center}
		...
		\caption[Framework propuesto]{Framework propuesto\\
			Fuente: \cite{pr_koh}. \citetitle{pr_koh}. (p. 3)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Comparación de rendimiento de los modelos \\
			Fuente: \cite{pr_koh}. \citetitle{pr_koh}. (p. 14)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Elaboración propia: Metodología propuesta por los autores. \\
			Fuente: \cite{pr_saferoute}. \citetitle{pr_saferoute}.}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Estructura de la red neuronal del modelo propuesto \\
			Fuente: \cite{pr_saferoute}. \citetitle{pr_saferoute}. (p. 5)}
		\label{1:fig2}
	\end{center}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Comparación de rendimiento de los modelos \\
			Fuente: \cite{pr_saferoute}. \citetitle{pr_saferoute}. (p. 11)}
		\label{1:fig2}
	\end{center}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Elaboración propia: Metodología propuesta por los autores \\
			Fuente: \citep*{pr_esquivel}. \citetitle{pr_esquivel}}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Estructura de la red convolucional LSTM basada en grafos \\
			Fuente: \citep*{pr_esquivel}. \citetitle{pr_esquivel}. (p. 4)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Riesgo de acoso sexual mediante combinación lineal \\
			Fuente: \citep*{pr_areiza}. \citetitle{pr_areiza}. (p. 3)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Elaboración propia: Metodología propuesta por los autores  \\
			Fuente: \citep*{pr_areiza}. \citetitle{pr_areiza}}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
\subsubsection{Resultados obtenidos}
Se presenta los resultados que son obtenidos por el algoritmo, estableciendo el origen en la Universidad EAFIT hasta la Universidad Nacional, el cual se puede visualizar en la tabla \ref{tab:results}.%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Metodología Propuesta \\
			Fuente: \citep*{pr_Soni}. \citetitle{pr_Soni}. (p. 1419)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Flujo de condición para detectar rutas seguras\\
			Fuente: \citep*{pr_Soni}. \citetitle{pr_Soni}. (p. 1420)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Resultados obtenidos\\
			Fuente: \citep*{pr_Soni}. \citetitle{pr_Soni}. (p. 1426)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Elaboración propia: Metodología propuesta por los autores \\
			Fuente: \citep*{pr_Ghoul}. \citetitle{pr_areiza}}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\citeauthor{pr_de} realizaron un artículo de investigación el cual fue publicado en la « International Journal of Geographical Information Science» en el año 2024. Este fue titulado \citetitle{pr_de} la cual traducida al español significa «Un algoritmo de enrutamiento basado en aprendizaje de refuerzo para grandes redes de calles».
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Framework Propuesto\\
			Fuente: \citep*{pr_de}. \citetitle{pr_de}. (p. 202)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Función de política del modelo \\
			Fuente: \citep*{pr_de}. \citetitle{pr_de}. (p. 199)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Puntuaciones de evaluación \\
			Fuente: \citep*{pr_de}. \citetitle{pr_de}. (p. 215)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\citeauthor{pr_zhang} realizaron un artículo de investigación el cual fue publicado en el « GLOBECOM 2020 » en el año 2020. Este fue titulado \citetitle{pr_zhang} la cual traducida al español significa «Un enfoque de aprendizaje profundo basado en agrupamiento de gráficos de motivos mejorado para la previsión del tráfico».
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Metodología EMGC-STGCN propuesta por los autores \\
			Fuente: \citep*{pr_zhang}. \citetitle{pr_zhang}. (p. 4)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Resultados de modelos propuestos con el conjunto de datos Nav-BJ \\
			Fuente: \citep*{pr_zhang}. \citetitle{pr_zhang}. (p. 5)}
		\label{1:fig2}
	\end{center}
\end{figure}
%\medskip
